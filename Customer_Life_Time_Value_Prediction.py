...
##############
#Aynı işlemi predict ile de yapabiliriz
##############
bgf.predict(1,
            cltv_df["frequency"],
            cltv_df["recency"],
            cltv_df["T"]).sort_values(ascending=False).head(10)
cltv_df["One_Week_Expected_Purchase"]=bgf.predict(1,
                                                  cltv_df["frequency"],
                                                  cltv_df["recency"],
                                                  cltv_df["T"])
################################################################
...
bgf.predict(4,
            ...
            cltv_df["recency"],
            cltv_df["T"]).sort_values(ascending=False).head(10)
cltv_df["One_Month_Expected_Purchase"]=bgf.predict(4,
                                                  cltv_df["frequency"],
                                                  cltv_df["recency"],
                                                  cltv_df["T"])

############################################
#Bir aylık periyotta beklenilen satış sayısı
############################################
bgf.predict(4,
            cltv_df["frequency"],
            cltv_df["recency"],
